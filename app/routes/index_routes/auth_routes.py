...
from app.services.card_services.login_cards_service import get_login_cards
from app.services.card_services.register_cards_service import get_register_cards
